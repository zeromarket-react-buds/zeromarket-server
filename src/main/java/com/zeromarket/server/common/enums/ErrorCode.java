...
public enum ErrorCode {
    ...
    KAKAO_TOKEN_REQUEST_FAILED(500, "카카오 토큰 요청에 실패했습니다."),
    ...
    DUPLICATE_RESOURCE(409, "중복된 정보가 존재합니다."),
    ...
    PRODUCT_NOT_FOR_SALE(403, "판매 중인 상품이 아닙니다."),
    CANNOT_BUY_OWN_PRODUCT(403, "자기 상품을 구매할 수 없습니다."),
    ...
    TRADE_INVALID_PAYMENT_AMOUNT(400, "거래 금액이 서버와 일치하지 않습니다."),
    DELIVERY_INFO_REQUIRED(409, "배송지 정보가 필요합니다."),
